...
const steps: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: "Crie metas de economia e acompanhe seu progresso. Quero comprar uma casa? Fazer uma viagem? O Monex te ajuda!",
...
export function OnboardingModal({ isOpen, onClose, onComplete }: OnboardingModalProps) {
  ...
  const handleComplete = async () => {
    ...
    toast.success("Configuração concluída! Bem-vindo ao Monex! 🎉")
    onComplete()
    onClose()
  }
